...
open class FrostedSidebar: UIViewController {
    ...
    */
    open var itemBackgroundColor:     UIColor                     = UIColor(white: 1, alpha: 1.00)
    /**
    ...
    */
    ...
    fileprivate class CalloutItem: UIView{
        ...
        override func layoutSubviews() {
            ...
            let inset2: CGFloat = bounds.size.height/1.2
            imageView.frame = CGRect(x: 0, y: 0, width: inset2, height: inset2)
